		...
		<div class="wrap">
			...
			<div class="post">
				...
				<div class="post-header">
					...
					<!-- 메뉴 더 보기 출력 -->
					<a href="#"><img src="Post/image/more.PNG" width="32px"
						height="20px" name="trigger" class="trigger" alt=""
						style="float: right;"></a>
				...
				<div class="post-footer">
					...
					<ul class="btn-container">
						...
						<!-- 좋아요 버튼 -->
						<li><a href="#"><img src="Post/image/heart.png"
								width="42px" height="32px" class="heart" name="heart" alt=""></li>

						<!-- 댓글달기 버튼 -->
						<li><a href="#"><img src="Post/image/balloon.png"
								width="41px" height="32px" alt=""></a></li>

						<!-- 공유하기 버튼 -->
						<li><a href="#"><img src="Post/image/plane.png"
								width="42px" height="32px" alt=""></a></li>

						<!-- 북마크 버튼 -->
						<a href="#"><img src="Post/image/bookmark.png" width="43px"
							height="32px" class="bookmark" name="bookmark" alt=""
							style="float: right;"></a>
					...
					<div class="super">
						<table class="formtable">
							<tr>
								...
								<td style="width: 600px;"><input class="hashtag"
									name="hashtag" style="width: 450px;" type="text"
									onkeyup="if(event.keyCode == 13) {var board_id = <%=board_id %>; var hashtag = value; 
									...
									<br> <span> <%
										List<String> hashlist = bdb.hashtagList(board_id);
										String hashtag = "";
										String hashid = "";
										String str = "";
										for(String hash:hashlist){
											hashtag = "#" + hash + " ";
											hashid = bdb.getHashId(board_id, hash);
					...
					<div class="text-container">
						<a href="#"><%=bdto.getUser_id() %></a> <span class="contents">
							<h5 class="contentsin"><%=bdto.getContent() %></h5>
						</span> <span>
							<button type="button" class="more"
								style="border: none; background-color: #fff; color: #8e8e8e;">...더
								보기</button>
						</span>
					</div>
           ...
           if(list.size()>2){ %>
						<a class="form2"
							href="Post/form2.jsp?board_id=<%=board_id%>&user_id=<%=user_id%>"
							style="cursor: pointer; margin-left: 15px; color: #8e8e8e;">댓글
							<%=list.size()%>개 모두 보기
						</a>
	          	 ...
	          	 CommentDto cdto=list.get(j);%>
							<div class="commentlist" style="margin: 10px 15px; height: 15px;">
								<div style="float: left; width: 450px;">
									...
									<p
										style="display: inline; width: 350px; background-color: white; border: none;"><%=cdto.getContent()%></p>
								</div>
								<div style="float: right;">
									<a href="#" class="joayo"><img src="images/mainheart.PNG"
										width="19px" height="19px" style="opacity: 0.6;" /></a>
								</div>
							</div>
							<%}
	        }else{ %>
